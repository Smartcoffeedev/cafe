import data from '@/db/faqData.json'
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="img-wrapper">
                            <div className="img-box" data-animation="fade-zoom-in" data-delay={0.1}>
                                <Image width={416} height={555} sizes='100vw' className="image-box-item" src="/img/all-img/faq-2.png" alt="image" />
                                <Image width={416} height={555} sizes='100vw' className="image-box-item" src="/img/all-img/faq.png" alt="image" />
                            </div>
                        </div>
                    </div>
